        ...
        <form wire:submit.prevent="submit" x-on:submit.prevent>
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white sm:p-6" x-data="{ isShowing: '{{$settings['mail_driver']}}' }">
                    ...
                    <div class="grid grid-cols-1 gap-y-3 gap-x-5 py-2 sm:grid-cols-2">
                        <div x-show="isShowing === 'smtp'">
                    ...
                    <div class="grid grid-cols-1 gap-y-3 gap-x-5 py-2 sm:grid-cols-2" x-show="isShowing === 'smtp'">
                        <div x-show="isShowing === 'smtp'">
                    ...
                    <div class="grid grid-cols-1 gap-y-3 gap-x-5 py-2 sm:grid-cols-2" x-show="isShowing === 'mailgun'">
                    ...
                    <div class="grid grid-cols-1 gap-y-4 gap-x-6 py-2 sm:grid-cols-3" x-show="isShowing === 'ses'">
                        <div>
