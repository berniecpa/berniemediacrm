...
<div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                        <td><a href="{{ route('payments.view', $payment->id) }}">{{ dateFormatted($payment->payment_date) }}</a></td>
                        <td><a href="{{ route('clients.view', $payment->client_id) }}">{{ $payment->company->name }}</a></td>
                        <td><a href="{{ route('invoices.view', $payment->invoice) }}">{{ $payment->invoice->reference_no }}</a></td>
