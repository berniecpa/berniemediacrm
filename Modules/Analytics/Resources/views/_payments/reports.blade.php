                                ...
                                <form>
                                    ...
                                    <div class="inline v-middle">
                                        ...
                                        <select class="form-control input-s-sm" id="filter-invoice" name="invoice">
                                            <option value="-">-</option>
                                            @foreach (Modules\Payments\Entities\Payment::select('id', 'invoice_id')->with('invoice:id,reference_no')->groupBy('invoice_id')->get() as $p)
                                            <option value="{{ $p->invoice_id }}">{{ optional($p->invoice)->reference_no }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="inline v-middle">
