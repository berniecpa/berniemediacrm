                                ...
                                <div class="col-sm-12 m-b-xs">
                                    <form>
                                        ...
                                        <select class="form-control input-s-sm" id="filter-project" name="project">
                                            <option value="-">-</option>
                                            @foreach (Modules\Expenses\Entities\Expense::select('id', 'project_id')->whereNotNull('project_id')->with('project:id,name')->groupBy('project_id')->get() as $expense)
                                            <option value="{{ $expense->project_id }}">{{ optional($expense->project)->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                        <div class="inline v-middle">
