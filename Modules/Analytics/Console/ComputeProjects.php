...
class ComputeProjects extends Command
{
    ...
    protected function avgBudget()
    {
        \App\Entities\Computed::updateOrCreate(
            ...
            ['value' => $this->project->active()->avg('used_budget')]
        );
    }
    protected function avgBillable()
    {
        \App\Entities\Computed::updateOrCreate(
            ...
            ['value' => $this->project->active()->avg('billable_time')]
        );
    }
    protected function avgProgress()
    {
        \App\Entities\Computed::updateOrCreate(
            ['key' => 'projects_average_progress'],
            ['value' => $this->project->avg('progress')]
        );
    }
    ...
    protected function avgExpenses()
    {
        ...
        \App\Entities\Computed::updateOrCreate(
            ...
            ['value' => $amount > 0 ? $amount / $this->project->count() : 0]
        );
    }
