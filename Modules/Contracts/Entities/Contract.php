...
class Contract extends Model
{
    ...
    protected $fillable = [
        ...
        'annotations', 'client_sign_id', 'contractor_sign_id', 'user_id', 'reminded_at', 'template_id',
    ];
    protected $cast = [
        'signed' => 'integer',
        'hourly_rate' => 'float',
    ...
    {
        return $this->isClient() || $this->user_id == \Auth::user()->id || \Auth::user()->can('contracts_view_all');
    }
    ...
    public function setLatePaymentFeeAttribute($value)
    {
        $this->attributes['late_payment_fee'] = is_null($value) ? 0.00 : $value;
    }
