    ...
    public function toMail($notifiable)
    {
        if ($notifiable->channelActive('mail', $this->type)) {
            return (new MailMessage())
                ...
                ->subject(langmail('tasks.commented.subject', ['project' => $this->task->project->name]))
                ->line(langmail('tasks.commented.body', ['name' => $this->task->name]))
                ->action('View Comment', route('projects.view', ['project' => $this->task->project->id, 'tab' => 'tasks', 'item' => $this->task->id]));
        }
    }
    ...
    public function toTelegram($notifiable)
    {
        if ($notifiable->channelActive('telegram', $this->type)) {
            return TelegramMessage::create()
                ...
                ->button('View Task', route('projects.view', ['project' => $this->task->project->id, 'tab' => 'tasks', 'item' => $this->task->id]));
        }
    }
}
