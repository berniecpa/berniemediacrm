    ...
    public function toMail($notifiable)
    {
        if ($notifiable->channelActive('mail', $this->type)) {
            return (new MailMessage())
                ...
                ->subject(langmail('tasks.created.subject', ['project' => $this->task->project->name]))
                ->line(langmail('tasks.created.body', ['name' => $this->task->name]))
                ->action('View Task', route('projects.view', ['project' => $this->task->project->id, 'tab' => 'tasks', 'item' => $this->task->id]));
        }
    }
