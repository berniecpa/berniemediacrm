                                ...
                                <div class="col-md-5 b-r">
                                    <div class="my-3 text-center">
                                        <span class="uppercase">
                                            @if (optional($expense->project)->id > 0)
                                            @langapp('project') :
                                    ...
                                    <div class="m-b-sm">
                                        @langapp('category') : <strong>{{ $expense->category->name }}</strong>
                                    </div>
                                    ...
                                    <div class="m-b-sm">
                                        @langapp('invoiced_in') :
                                        <strong>
                                            <a href="{{ route('invoices.view', ['invoice' => $expense->invoice_id]) }}">
                                                #{{ $expense->invoice->reference_no }}
                                            </a>
                                        </strong>
                                    </div>
                                    @endif
