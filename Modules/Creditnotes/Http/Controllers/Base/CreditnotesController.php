        ...
        return DataTables::eloquent($model)
            ->editColumn(
                ...
                function ($creditnote) {
                    ...
                    $str .= '<a class="' . themeLinks('font-semibold') . '" href="' . route('creditnotes.view', $creditnote->id) . '">' . $creditnote->reference_no . '</a>';
                    return $str;
                }
            )
            ->editColumn(
            ...
            ->editColumn(
                'status',
                function ($creditnote) {
                    return '<span class="text-gray-700 uppercase">' . $creditnote->status . '</span>';
                }
            )
            ->editColumn(
                'amount',
