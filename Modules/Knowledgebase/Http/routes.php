...
Route::group(
    ...
    function () {
        ...
        Route::get('/category/{group}', 'KbCustomController@byCategory')->name('kb.articles')->middleware('can:menu_knowledgebase');
        ...
        Route::delete('destroy/{kb}', 'KbCustomController@destroy')->name('kb.destroy')->middleware('can:articles_delete');
        ...
        Route::get('vote/{kb}/{vote}', 'KbCustomController@vote')->name('kb.vote');
    }
);
