                    ...
                    <div class="col-md-12 m-t-sm">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                @foreach (App\Entities\Status::select('id', 'name')->get() as $status)
                        ...
                        <div class="rows">
                            <section class="">
                                    ...
                                    <ul class="list-group no-radius">
                                        ...
                                        <li class="list-group-item">
                                            <span class="pull-right"><label class="label label-default">
                                                    @langapp($ticket->status->name)</label>
                                            </span>@langapp('status')
                                        </li>
                                        <li class="list-group-item">
                                            <span class="pull-right">@langapp(strtolower($ticket->priority->name))</span>
                                            @langapp('priority')
                                        </li>
                                        <li class="list-group-item">
                                ...
                                <div class="bg-white rounded-sm col-md-8">
                                    <div class="ribbon {{is_null($ticket->closed_at) ? 'info' : 'success' }}">
                                        <span>@langapp($ticket->status->name)</span>
                                    </div>
