                    ...
                    <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Billing Isssue" name="subject" required>
                            </div>
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-body">
                                        <div>
                                            <a href="{{ route('kb.view', $article->id) }}" class="text-ellipsis">@icon('solid/lightbulb') {{ $article->subject }}</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
