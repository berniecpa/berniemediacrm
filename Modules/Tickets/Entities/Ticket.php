...
class Ticket extends Model
{
    ...
    protected $fillable = [
        'code', 'subject', 'body', 'status_id', 'department', 'user_id', 'project_id', 'priority_id', 'due_date', 'is_locked',
    ...
    public function statusIcon()
    {
        ...
        if (strtolower($this->status->name) === 'pending') {
    ...
    public function closeTicket()
    {
        ...
        $this->status_id = Status::where('name', 'closed')->first()->id;
    ...
    public function openTicket()
    {
        $this->closed_at = null;
        $this->closed_by = 0;
        $this->status_id = Status::where('name', 'open')->first()->id;
