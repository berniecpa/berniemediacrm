...
class User extends Authenticatable implements HasLocalePreference, MustVerifyEmail
{
    ...
    {
        return $this->hasMany(Ticket::class)->with(['status', 'dept', 'priority'])->orderBy('id', 'desc');
    }
    ...
    {
        return $this->hasMany(Lead::class, 'sales_rep')->with('status:id,name', 'source:id,name')->orderByDesc('id');
    }
