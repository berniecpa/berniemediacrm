        ...
        <div class="panel invoice-grid widget-b">
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h6 class="text-semibold"><a href="{{ route('expenses.view', $expense->id)  }}">#{{ $expense->code }}</a>
                        </h6>
            ...
            <div class="panel-footer panel-footer-condensed">
                ...
                <div class="heading-elements">
                    <span class="heading-text">
                        ...
                        <a href="{{ route('projects.view', ['project' => $expense->project_id]) }}">
                            {{ str_limit($expense->project->name, 40) }}
                        </a>
                        @else N/A
                        @endif
                    </span>

                    <a href="{{  route('expenses.view', $expense->id)  }}" class="btn {{themeButton()}} pull-right">
