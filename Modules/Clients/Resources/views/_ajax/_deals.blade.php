        ...
        @foreach ($chunk as $deal)
            <div class="col-md-6">
                        <div class="panel invoice-grid widget-b">
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <h6 class="text-semibold"><a href="{{  route('deals.view', $deal->id)  }}">{{  $deal->title  }}</a>
                                        </h6>
                        ...
                        <span class="heading-text">
                            @icon('solid/user-circle') <a href="{{ route('contacts.view', ['user' => $deal->contact_person]) }}">{{ $deal->contact->name }}</a>
                        </span>

                                    <span class="pull-right">@icon('solid/globe') {{ $deal->source->name }}</span>
