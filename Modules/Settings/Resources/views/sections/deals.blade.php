<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <section class="panel panel-default">
            ...
            <input class="display-none" type="text" name="contact_mail_username" />
            <input class="display-none" type="password" name="contact_mail_password" />
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label" data-rel="tooltip" title="Create an invoice automatically when a deal is won">@langapp('auto_invoice')
                        @icon('solid/question-circle')</label>
                    <div class="col-lg-7">
                        <label class="switch">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        ...
                        <select class="select2-option form-control" name="default_deal_stage" required>
                            ...
                            @foreach (App\Entities\Category::where('module','deals')->select('id', 'name', 'pipeline')->get() as $stage)
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" class="form-control" value="{{  get_option('contact_mail_host')  }}" name="contact_mail_host">
                    </div>
                </div>
