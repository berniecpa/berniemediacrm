...
class ProjectPolicy
{
    ...
    {
        return $project->isTeam() || $user == $project->manager;
    }
    ...
    {
        return $project->isTeam() || $project->isClient() || $user->can('invoices_view_all');
    }
    /**
    ...
    {
        return $project->isTeam() || $project->isClient() || $user->can('expenses_view_all');
    }
    /**
