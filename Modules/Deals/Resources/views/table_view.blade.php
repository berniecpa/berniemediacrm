<div class="col-lg-12">
    ...
    <section class="panel panel-default">
        ...
        <form id="frm-deal" method="POST">
                ...
                <table id="deals-table" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="hidden-sm">@langapp('assigned') </th>
            ...
            @can('deals_update')
            <button type="submit" id="button" class="btn {{themeButton()}} m-xs" value="bulk-archive">
                <span class="">@icon('solid/archive') @langapp('archive')</span>
            </button>
            @endcan

            @can('deals_delete')
            <button type="submit" class="btn {{themeButton()}} m-sm" value="bulk-delete">
