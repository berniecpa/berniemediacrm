        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <select name="status_id" class="form-control">
                    ...
                    <option value="{{ $s->id }}" {{ $status == $s->id ? 'selected' : '' }}>{{ ucfirst($s->name) }}</option>
                    @endforeach
            ...
            <div class="form-group">
                ...
                <select name="priority" class="form-control">
                    @foreach (App\Entities\Priority::all() as $priority)
                    <option value="{{strtolower($priority->name)}}">@langapp(strtolower($priority->name)) </option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <x-inputs.wysiwyg name="description" class="{{ get_option('htmleditor') }}" id="description">

                </x-inputs.wysiwyg>
            </div>

            <div class="form-group">
                <label class="control-label">@langapp('reproducibility') @required</label>
                <x-inputs.wysiwyg name="reproducibility" class="{{ get_option('htmleditor') }}" id="reproducibility">
