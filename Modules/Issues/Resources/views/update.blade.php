    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ $issue->code }}" name="code" readonly>
            </div>
            ...
            @if (isAdmin() || $issue->project->isTeam())
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="status_id" class="form-control">
                    ...
                    <option value="{{ $s->id }}" {{ $issue->status_id == $s->id ? 'selected' : '' }}>{{ ucfirst($s->status->name) }}</option>
                    @endforeach
            ...
            <div class="form-group">
                ...
                <select name="assignee" class="form-control select2-option">
                    ...
                    @foreach ($issue->project->assignees as $member)
